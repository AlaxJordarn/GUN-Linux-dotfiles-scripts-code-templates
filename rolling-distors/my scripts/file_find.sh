...
if [ $p  ==  "normal" ]
then
locate -b $x | dmenu -l 30 | xargs -I {} termite -e " nano  "{}" "
fi

if [ $p  == "root" ]
then
locate -b $x | dmenu -l 30 | xargs -I {} termite -e "sudo  nano  "{}" "
fi
...
#locate -b $x | dmenu -l 30 | xargs -I {}  termite -e " $y "{}" "
#locate and open only vim 
#locate -b $x | dmenu -l 30 | xargs -I {} termite -e " vim "{}" "
